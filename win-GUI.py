#!/usr/bin/env python
"""
Beispiel für (fast) alle Elemente, die Sie in PySimpleGUI verwenden können.
Zeigt Ihnen die Grundlagen, einschließlich:
Namenskonvention für Schlüssel
Menüleistenformat
Rechtsklick-Menüformat
Tabellenformat
Ausführen einer asynchronen Ereignisschleife
Designen Ihrer Anwendung (erfordert einen Neustart des Fensters)
Zeigt den Werteverzeichniseintrag für jedes Element an
Und mehr!
